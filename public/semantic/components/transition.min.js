        ...
        r.each(function (t) {
          var d,
            ...
            f = {
              ...
              animate: function (n) {
                if (((d = n || d), !f.is.supported()))
                  return f.error(e.support), !1;
                if (
                  (f.debug('Preparing animation', d.animation),
                  f.is.animating())
                ) {
                  if (d.queue)
                    return (
              ...
              set: {
                ...
                duration: function (n, e) {
                  (!(e =
                    ...
                    m.css({ 'animation-duration': e }));
                },
                direction: function (n) {
                  (n = n || f.get.direction()) == c.inward
                    ? f.set.inward()
                    : f.set.outward();
                },
                looping: function () {
              ...
              get: {
                settings: function (n, e, i) {
                  return 'object' == typeof n
                    ...
                    : 'object' == typeof e
                    ? C.extend({}, C.fn.transition.settings, e, {
                        animation: n,
                      })
                    : 'function' == typeof e
                    ? C.extend({}, C.fn.transition.settings, {
                ...
                displayType: function (n) {
                  return (
                    ...
                    d.displayType
                      ? d.displayType
                      : (n &&
                          m.data(i.displayType) === S &&
                          f.can.transition(!0),
                        m.data(i.displayType))
                  );
                },
                userStyle: function (n) {
                  return (n = n || m.attr('style') || '').replace(
                    /display.*?;/,
                    ''
                  );
                },
              ...
              setting: function (n, e) {
                if ((f.debug('Changing setting', n, e), C.isPlainObject(n)))
                  C.extend(!0, d, n);
                else {
                  if (e === S) return d[n];
                  ...
                  'string' == typeof t &&
                    ...
                    C.each(t, function (n, e) {
                      ...
                      if (C.isPlainObject(r[i]) && n != a) r = r[i];
                        ...
                        if (!C.isPlainObject(r[e]) || n == a)
                          return r[e] !== S && (o = r[e]), !1;
                        r = r[e];
                      }
                    })),
