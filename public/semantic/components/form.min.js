        ...
        E.each(function () {
          var n,
            ...
            y = {
              ...
              destroy: function () {
                y.verbose('Destroying previous module', g),
                  y.removeEvents(),
                  o.removeData(a);
              },
              refresh: function () {
              ...
              bindEvents: function () {
                y.verbose('Attaching form events'),
                  ...
                  d.keyboardShortcuts &&
                    o.on('keydown' + m, f.field, y.event.field.keydown),
                  n.each(function () {
                    var e = T(this),
                      t = e.prop('type'),
                ...
                n.each(function () {
                  ...
                  i !== O &&
                    ...
                    o
                      ...
                      : a
                      ? (y.verbose('Resetting checkbox value', t, i),
                        e.prop('checked', i))
              ...
              event: {
                field: {
                  ...
                  blur: function (e) {
                    ...
                    n.hasClass(p.error)
                      ? (y.debug('Revalidating field', t, r),
                        r && y.validate.field(r))
                  ...
                  change: function (e) {
                    ...
                    r &&
                      ('change' == d.on ||
                        (n.hasClass(p.error) && d.revalidate)) &&
                ...
                prompt: function (e, t) {
                  ...
                  return (
                    ...
                    c &&
                      ...
                      (s = s.replace('{name}', r))),
                    (s = (s = s.replace('{identifier}', t.identifier)).replace(
                      '{ruleValue}',
                      a
                    )),
                    e.prompt ||
                ...
                field: function (e) {
                  return (
                    ...
                    0 < n.filter('#' + e).length
                      ...
                      ? n.filter('[name="' + e + '[]"]')
                      : 0 <
                        n.filter('[data-' + c.validate + '="' + e + '"]').length
              ...
              remove: {
                rule: function (n, e) {
                  ...
                  if (e == O)
                    return y.debug('Removed all rules'), void (u[n].rules = []);
                  u[n] != O &&
                    T.isArray(u[n].rules) &&
                    T.each(u[n].rules, function (e, t) {
                      -1 !== r.indexOf(t.type) &&
                        (y.debug('Removed rule', t.type),
                        u[n].rules.splice(e, 1));
                    });
                },
                field: function (e) {
              ...
              validate: {
                ...
                field: function (n, e, t) {
                  (t = t === O || t),
                    'string' == typeof n &&
                      (y.verbose('Validating field', n), (n = u[(e = n)]));
                  ...
                  return (
                    n.identifier ||
                      (y.debug('Using field name as identifier', r),
                      (n.identifier = r)),
                    i.prop('disabled')
                      ? (y.debug('Field is disabled. Skipping', r), (o = !0))
                      : n.optional && y.is.blank(i)
                      ? (y.debug('Field is optional and blank. Skipping', r),
                        (o = !0))
                  ...
                  'string' == typeof r &&
                    ...
                    T.each(r, function (e, t) {
                      var n =
                        e != i
                          ? t +
                            r[e + 1].charAt(0).toUpperCase() +
                            r[e + 1].slice(1)
                          : r;
                      if (T.isPlainObject(o[n]) && e != i) o = o[n];
                      else {
                        if (o[n] !== O) return (a = o[n]), !1;
                        if (!T.isPlainObject(o[t]) || e == i)
                          return o[t] !== O && (a = o[t]), !1;
                        o = o[t];
                      }
                    })),
    ...
    (T.fn.form.settings = {
      ...
      rules: {
        ...
        regExp: function (e, t) {
          ...
          return (
            r &&
              ((t = 2 <= r.length ? r[1] : t), (n = 3 <= r.length ? r[2] : '')),
        ...
        maxCount: function (e, t) {
          return (
            0 != t && (1 == t ? -1 === e.search(',') : e.split(',').length <= t)
          );
        },
      },
    });
