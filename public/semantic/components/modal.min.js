          ...
          var i,
            ...
            S = {
              ...
              hideAll: function (e) {
                ...
                (e = j.isFunction(e) ? e : function () {}),
                  0 < n.length &&
                    ...
                    S.hideDimmer(),
                    n.modal('hide modal', e));
              },
              hideOthers: function (e) {
                var n = t.filter('.' + d.active + ', .' + d.animating);
                (e = j.isFunction(e) ? e : function () {}),
                  0 < n.length &&
                    (S.debug('Hiding other modals', t),
                    n.modal('hide modal', e, !0));
              },
              others: {
                active: function () {
              ...
              add: {
                keyboardShortcuts: function () {
                  S.verbose('Adding keyboard shortcuts'),
                    M.on('keyup' + f, S.event.keyboard);
                },
              },
              save: {
                focus: function () {
                  0 < j(L.activeElement).closest(h).length ||
                    (e = j(L.activeElement).blur());
                },
              },
              restore: {
                focus: function () {
              ...
              cacheSizes: function () {
                ...
                (S.cache !== N && 0 === i) ||
                  ((S.cache = {
                    ...
                    contextHeight:
                      'body' == c.context ? j(q).height() : o.height(),
                  }),
              ...
              is: {
                ...
                ie: function () {
                  return (
                    (!q.ActiveXObject && 'ActiveXObject' in q) ||
                    'ActiveXObject' in q
                  );
                },
                animating: function () {
              ...
              setting: function (e, n) {
                if ((S.debug('Changing setting', e, n), j.isPlainObject(e)))
                  j.extend(!0, c, e);
                else {
                  if (n === N) return c[e];
