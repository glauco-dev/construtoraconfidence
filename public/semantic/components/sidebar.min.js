          ...
          var s,
            ...
            y = {
              ...
              event: {
                ...
                scroll: function (e) {
                  0 === D(e.target).closest(n.sidebar).length &&
                    e.preventDefault();
                },
              },
              bind: {
                clickaway: function () {
                  y.verbose('Adding clickaway events to context', h),
                    c.closable &&
                      h
                        .on('click' + a, y.event.clickaway)
                        .on('touchend' + a, y.event.clickaway);
                },
                scrollLock: function () {
                  c.scrollLock &&
                    (y.debug('Disabling page scroll'),
                    w.on('DOMMouseScroll' + a, y.event.scroll)),
              ...
              unbind: {
                clickaway: function () {
                  y.verbose('Removing clickaway events from context', h),
                    h.off(a);
                },
                scrollLock: function () {
              ...
              setup: {
                ...
                layout: function () {
                  0 === h.children(n.pusher).length &&
                    ...
                    y.refresh()),
                    (0 !== b.nextAll(n.pusher).length &&
                      b.nextAll(n.pusher)[0] === g[0]) ||
              ...
              attachEvents: function (e, i) {
                ...
                (i = D.isFunction(y[i]) ? y[i] : y.toggle),
                  0 < n.length
                    ? (y.debug('Attaching sidebar events to element', e, i),
                      n.on('click' + u, i))
                    : y.error(d.notFound, e);
              },
              show: function (e) {
                if (
                  ((e = D.isFunction(e) ? e : function () {}), y.is.hidden())
                ) {
                  if (
                    (y.refreshSidebars(),
                    c.overlay &&
                      (y.error(d.overlay), (c.transition = 'overlay')),
                    y.refresh(),
                    y.othersActive())
                  )
                    if (
                      (y.debug('Other sidebars currently visible'), c.exclusive)
                    ) {
              ...
              remove: {
                inlineCSS: function () {
                  y.debug('Removing inline css styles', s),
                    s && 0 < s.length && s.remove();
                },
                ios: function () {
                  x.removeClass(r.ios);
                },
              ...
              is: {
                ...
                rtl: function () {
                  return (
                    y.cache.rtl === z &&
                      (y.cache.rtl = 'rtl' == b.css('direction')),
                    y.cache.rtl
                  );
                },
              },
              setting: function (e, i) {
                if ((y.debug('Changing setting', e, i), D.isPlainObject(e)))
                  D.extend(!0, c, e);
                else {
                  if (i === z) return c[e];
                    ...
                    D.each(t, function (e, i) {
                      ...
                      if (D.isPlainObject(s[n]) && e != o) s = s[n];
                        ...
                        if (!D.isPlainObject(s[i]) || e == o)
                          return (
                            s[i] !== z ? (r = s[i]) : y.error(d.method, t), !1
                          );
                        s = s[i];
                      }
                    })),
