            ...
            p = {
              ...
              destroy: function () {
                p.verbose('Destroying previous instance'),
                  ...
                  t && t.disconnect(),
                  f
                    .off('load' + c, p.event.load)
                    .off('resize' + c, p.event.resize),
              ...
              bind: {
                events: function () {
                  f
                    .on('load' + c, p.event.load)
                    .on('resize' + c, p.event.resize),
                    u
                      .off('scroll' + c)
              ...
              supports: {
                sticky: function () {
                  ...
                  e[0];
                  return (
                    e.addClass(o.supported), e.css('position').match('sticky')
                  );
                },
              },
              save: {
              ...
              set: {
                offset: function () {
                  p.verbose('Setting offset on element', m.offset),
                    a.css('margin-top', m.offset);
                },
                    ...
                    : ((e = Math.max(
                      ...
                      m.jitter
                        ? (p.debug(
                          ...
                          n.css({ height: e }))
                        : n.css({ height: '' }),
                      Math.abs(n.outerHeight() - p.cache.context.height) >
                        m.jitter &&
                        (p.debug(
                  ...
                  'string' == typeof n &&
                    ...
                    T.each(n, function (e, t) {
                      ...
                      if (T.isPlainObject(r[o]) && e != i) r = r[o];
                        ...
                        if (!T.isPlainObject(r[t]) || e == i)
                          return r[t] !== P && (s = r[t]), !1;
                        r = r[t];
                      }
                    })),
