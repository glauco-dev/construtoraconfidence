        ...
        var r = E.isPlainObject(m)
          ...
          f = {
            ...
            read: {
              ...
              settings: function () {
                !1 !== r.total &&
                  (f.debug('Current total set in settings', r.total),
                  f.set.total(r.total)),
                  !1 !== r.value &&
            ...
            set: {
              ...
              percent: function (e) {
                (e = 'string' == typeof e ? +e.replace('%', '') : e),
                  ...
                  f.has.total() ||
                    ((f.value =
                      0 < r.precision
                        ? Math.round((e / 100) * f.total * (10 * r.precision)) /
                          (10 * r.precision)
                        : Math.round((e / 100) * f.total * 10) / 10),
                    r.limitValues &&
                      (f.value =
                        100 < f.value ? 100 : f.value < 0 ? 0 : f.value)),
                  f.set.barWidth(e),
                  f.set.labelInterval(),
                  f.set.labels(),
              ...
              labelInterval: function () {
                clearInterval(f.interval),
                  ...
                  (f.interval = setInterval(function () {
                    E.contains(P.documentElement, g) ||
                      (clearInterval(f.interval), (p = !1)),
                      f.set.labels();
                  }, r.framerate));
              },
              labels: function () {
              ...
              barLabel: function (e) {
                e !== T
                  ...
                  ? (f.verbose('Adding ratio to bar label'),
                    u.text(f.get.text(r.text.ratio)))
                  : 'percent' == r.label &&
              ...
              active: function (e) {
                (e = e || r.text.active),
                  ...
                  f.remove.error(),
                  f.remove.success(),
                  (e = r.onLabelUpdate('active', e, f.value, f.total)) &&
                    f.set.label(e),
                  f.bind.transitionEnd(function () {
              ...
              warning: function (e) {
                (e = e || r.text.warning),
                  ...
                  f.remove.error(),
                  f.complete(),
                  (e = r.onLabelUpdate('warning', e, f.value, f.total)) &&
                    f.set.label(e),
                  f.bind.transitionEnd(function () {
              ...
              error: function (e) {
                (e = e || r.text.error),
                  ...
                  f.remove.warning(),
                  f.complete(),
                  (e = r.onLabelUpdate('error', e, f.value, f.total)) &&
                    f.set.label(e),
                  f.bind.transitionEnd(function () {
            ...
            setting: function (e, t) {
              if ((f.debug('Changing setting', e, t), E.isPlainObject(e)))
                E.extend(!0, r, e);
              else {
                if (t === T) return r[e];
                  ...
                  E.each(r, function (e, t) {
                    ...
                    if (E.isPlainObject(i[n]) && e != a) i = i[n];
                      ...
                      if (!E.isPlainObject(i[t]) || e == a)
                        return (
                          i[t] !== T ? (o = i[t]) : f.error(s.method, r), !1
                        );
                      i = i[t];
                    }
                  })),
